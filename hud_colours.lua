...
HUD_COLOURS = {
	...
	HUD_COLOUR_SCRIPT_VARIABLE = 128, -- marked by ~v~. Can be altered with the SET_SCRIPT_VARIABLE_HUD_COLOUR script command
	HUD_COLOUR_YOGA = 129,
	...
	HUD_COLOUR_SCRIPT_VARIABLE_2 = 165, -- marked by ~u~. Can be altered with the SET_SECOND_SCRIPT_VARIABLE_HUD_COLOUR script command
	HUD_COLOUR_H = 166,
